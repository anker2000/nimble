				...
				<nav class="container">
					...
					<div class="row">
						...
						<div class="col-sm-offset-1 col-sm-10">
							<?php
							$args = array( 'menu' => 'nimble-menu', 'menu_class' => '','container_class' => false, 'container' => '', 'echo' => false, 'theme_location' => 'primary');
							$menu=wp_nav_menu($args);
							echo str_replace('<a href="#">logo-placeholder</a>','<span class="logo-placeholder"></span>',$menu);
							?>
						</div>
					</div>
				</nav>
